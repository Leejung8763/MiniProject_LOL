...
summonerList = pd.read_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/summonerList{args.begin.replace('2021','').replace('-','')}.csv")
...
for summonerIndex in range(len(summonerList)):
    try:
        ...
        summonerIdList = pd.concat([summonerIdList, summonerIdListTmp], axis=0, ignore_index=True)
        ...
        if (summonerIndex%20 == 0)|(summonerIndex == len(summonerList)-1):
            ...
            # save to csv
            pd.merge(summonerList, summonerIdList.drop("summonerName", axis=1), on=["summonerId"], how="left").to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/summonerList{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            Match.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/Match{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            ParticipantIdentity.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/ParticipantIdentity{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            TeamStats.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/TeamStats{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            Participant.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/Participant{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            MatchTimeline.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/MatchTimeline{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            MatchFrame.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/MatchFrame{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            MatchParticipantFrame.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/MatchParticipantFrame{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            MatchEvent.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/MatchEvent{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
            MatchReference.reset_index(drop=True).to_csv(f"/data1/lolData/cgLeague/API_csv/{args.begin.replace('2021','').replace('-','')}/MatchReference{args.begin.replace('2021','').replace('-','')}.csv", index=False, encoding='utf-8-sig')
    except:
        time.sleep(2)
